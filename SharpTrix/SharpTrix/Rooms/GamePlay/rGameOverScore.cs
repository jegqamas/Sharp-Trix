...
namespace AHD.SharpTrix
{
    ...
    /// </summary>
    public class rGameOverScore : Microsoft.Xna.Framework.GameComponent
    {
        ...
        public rGameOverScore(Game game, rGamePlay gameplay)
            : base(game)
        {
        ...
        {
            spriteBatch.DrawString(Font_large, "GAME OVER !!", new Vector2((base.Game.GraphicsDevice.Viewport.Width / 2) -
(Font_large.MeasureString("GAME OVER !!").X / 2), 50), Color.White);
           ...
           new Rectangle(x, y, paperWidth, paperHeight), Color.White);
            if (!ShowTotalScore)
            {
            ...
            if (!ShowTotalScore)//Show players winning arrange
            {
                int ssy = y + 20;
                int ssx = x + 10;
                int sx = x + 130;
                spriteBatch.DrawString(Font_normal, "Players Chart", new Vector2(ssx, ssy), Color.DarkBlue);
                ssy += 50;
                spriteBatch.DrawString(Font_small, "1ST:", new Vector2(ssx, ssy), Color.DarkBlue);
                spriteBatch.DrawString(Font_small, gameplay.trixBartyiah.GameOverWinningArrange[3].Name + " with score "
                    + gameplay.trixBartyiah.GameOverWinningArrange[3].Score, new Vector2(sx, ssy), Color.DarkBlue);
                ssy += 30;
                spriteBatch.DrawString(Font_small, "2ND:", new Vector2(ssx, ssy), Color.DarkBlue);
                spriteBatch.DrawString(Font_small, gameplay.trixBartyiah.GameOverWinningArrange[2].Name + " with score "
                    + gameplay.trixBartyiah.GameOverWinningArrange[2].Score, new Vector2(sx, ssy), Color.DarkBlue);
                ssy += 30;
                spriteBatch.DrawString(Font_small, "3RD:", new Vector2(ssx, ssy), Color.DarkBlue);
                spriteBatch.DrawString(Font_small, gameplay.trixBartyiah.GameOverWinningArrange[1].Name + " with score "
                    + gameplay.trixBartyiah.GameOverWinningArrange[1].Score, new Vector2(sx, ssy), Color.DarkBlue);
                ssy += 30;
                spriteBatch.DrawString(Font_small, "4TH:", new Vector2(ssx, ssy), Color.DarkBlue);
                spriteBatch.DrawString(Font_small, gameplay.trixBartyiah.GameOverWinningArrange[0].Name + " with score "
                    + gameplay.trixBartyiah.GameOverWinningArrange[0].Score, new Vector2(sx, ssy), Color.DarkBlue);
            }
            else
            {
                int ssy = y + 20;
